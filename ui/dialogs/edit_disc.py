"""
Диалог редактирования носителя.
"""

import customtkinter as ctk
from tkinter import messagebox
from data import update_disc
from ui.dialogs.base_dialog import BaseDialog


class EditDiscDialog(BaseDialog):
    def get_default_geometry(self):
        return "350x200"

    def __init__(self, master, disc, stock_tab=None):
        super().__init__(master)

        self.title("Редактировать носитель")
        ...
        self.name_entry.insert(0, disc.get('name', ''))
        ...
        self.desc_entry.insert(0, disc.get('description', ''))
    ...
    def ok(self):
        ...
        try:
            update_disc(self.disc.doc_id, name, description)
            self.accepted = True
            self.destroy()
